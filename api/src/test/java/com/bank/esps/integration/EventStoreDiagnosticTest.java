...
class EventStoreDiagnosticTest {
    ...
    void testEventStore_SaveAndRetrieve() {
        ...
        System.err.println("Found " + events.size() + " events for position " + positionKey);
        ...
        System.err.println("  Position Key: " + event.getPositionKey());
        System.out.println("  Version: " + event.getEventVer());
        System.err.println("  Version: " + event.getEventVer());
        System.out.println("  Type: " + event.getEventType());
        System.err.println("  Type: " + event.getEventType());
        System.out.println("  Effective Date: " + event.getEffectiveDate());
        System.err.println("  Effective Date: " + event.getEffectiveDate());
        System.out.println("  Occurred At: " + event.getOccurredAt());
        System.err.println("  Occurred At: " + event.getOccurredAt());
        System.out.println("  Payload Length: " + (event.getPayload() != null ? event.getPayload().length() : 0));
        System.err.println("  Payload Length: " + (event.getPayload() != null ? event.getPayload().length() : 0));
