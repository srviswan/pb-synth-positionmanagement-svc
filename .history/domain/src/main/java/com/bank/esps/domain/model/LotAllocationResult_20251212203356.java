...
public class LotAllocationResult {
    ...
    /**
     * Remaining quantity after lot reduction (for sign change scenarios)
     * - Positive: Normal reduction, all lots closed
     * - Negative: Sign change occurred, remaining quantity becomes short position
     * - Zero: All quantity allocated to lots
     */
