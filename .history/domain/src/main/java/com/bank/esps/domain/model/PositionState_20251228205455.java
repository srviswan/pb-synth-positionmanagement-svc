...
public class PositionState {
     ...
     * Includes both long (positive qty) and short (negative qty) lots
     */
    ...
    /**
     * Get all lots (including closed ones) - for snapshot persistence
     */
    public List<TaxLot> getAllLots() {
        return new ArrayList<>(openLots);
    }
    
    /**
     * Get total quantity across all open lots
     * Safely handles null quantities by treating them as zero
     */
     ...
     * Safely handles null quantities and prices by treating them as zero
     */
