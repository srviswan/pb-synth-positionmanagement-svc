...
public class EventEntity {
    ...
    private String payload; // JSON string (JSONB in PostgreSQL, NVARCHAR(MAX) in SQL Server)
    
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "meta_lots")
    private String metaLots; // JSON string (JSONB in PostgreSQL, NVARCHAR(MAX) in SQL Server)
