...
public class RegulatorySubmissionEntity {
    ...
    private String responsePayload; // JSON (JSONB in PostgreSQL, NVARCHAR(MAX) in SQL Server)
    
    @Column(name = "error_message", columnDefinition = "NVARCHAR(MAX)")
    private String errorMessage; // NVARCHAR(MAX) in SQL Server, TEXT in PostgreSQL
