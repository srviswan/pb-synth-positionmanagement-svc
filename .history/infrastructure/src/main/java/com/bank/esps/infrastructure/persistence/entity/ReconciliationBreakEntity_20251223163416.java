...
public class ReconciliationBreakEntity {
    ...
    private String internalValue; // JSON (JSONB in PostgreSQL, NVARCHAR(MAX) in SQL Server)
    
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "external_value")
    private String externalValue; // JSON (JSONB in PostgreSQL, NVARCHAR(MAX) in SQL Server)
    
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "regulatory_value")
    private String regulatoryValue; // JSON (JSONB in PostgreSQL, NVARCHAR(MAX) in SQL Server)
    ...
    private String resolutionNotes; // NVARCHAR(MAX) in SQL Server, TEXT in PostgreSQL
