...
This approach is **much simpler** and **more maintainable** than the current sign-change detection approach. The key insight is: **Long and short positions should have different position_keys**.
