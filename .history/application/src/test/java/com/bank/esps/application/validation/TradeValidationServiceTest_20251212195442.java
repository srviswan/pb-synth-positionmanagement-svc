...
class TradeValidationServiceTest {
    ...
    @Mock
    private com.bank.esps.application.statemachine.PositionStateMachine stateMachine;
    ...
    void setUp() {
        ...
        com.bank.esps.application.statemachine.PositionStateMachine realStateMachine = 
                new com.bank.esps.application.statemachine.PositionStateMachine();
        
        validationService = new TradeValidationService(snapshotRepository, realStateMachine);
    }
    ...
    void testIncreaseOnNonExistentPosition() {
        ...
        assertTrue(result.getErrors().stream()
                .anyMatch(e -> e.contains("does not exist") && e.contains("Only NEW_TRADE")));
    }
    ...
    void testIncreaseOnTerminatedPosition() {
        ...
        assertFalse(result.isValid());
        assertTrue(result.getErrors().stream()
                .anyMatch(e -> e.contains("INCREASE not allowed on TERMINATED position")));
    }
