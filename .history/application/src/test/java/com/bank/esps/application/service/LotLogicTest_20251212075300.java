...
class LotLogicTest {
    ...
    void testReduceLotsFIFO() {
        ...
        LotAllocationResult result = lotLogic.reduceLots(state, new BigDecimal("150"), rules);
    ...
    void testReduceLotsLIFO() {
        ...
        LotAllocationResult result = lotLogic.reduceLots(state, new BigDecimal("100"), rules);
    ...
    void testReduceLotsInsufficientQuantity() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            lotLogic.reduceLots(state, new BigDecimal("200"), rules);
        });
    }
}
