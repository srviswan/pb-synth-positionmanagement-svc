...
class TradeValidationServiceTest {
    ...
    void setUp() {
        ...
        // Create a real PositionKeyGenerator instance for testing
        com.bank.esps.application.util.PositionKeyGenerator positionKeyGenerator = 
                new com.bank.esps.application.util.PositionKeyGenerator();
        
        validationService = new TradeValidationService(snapshotRepository, stateMachine, positionKeyGenerator);
    }
