...
public class HotpathPositionService {
    ...
    /**
     * Update PriceQuantity Schedule for position
     */
    private void updatePriceQuantitySchedule(PositionState state, TradeEvent tradeEvent) {
        ...
        java.time.LocalDate effectiveDate = tradeEvent.getEffectiveDate() != null 
        ...
        if (effectiveDate != null) {
            ...
            state.getPriceQuantitySchedule().addOrUpdateEntry(effectiveDate, currentQty, weightedAvgPrice);
        }
    }
}
