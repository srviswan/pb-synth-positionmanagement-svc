...
public interface MessageProducer {
    ...
    /**
     * Publish a regulatory event (e.g., UPI invalidation)
     * @param positionKey The position key
     * @param regulatoryEvent The regulatory event payload (JSON string)
     * @return CompletableFuture that completes when message is sent
     */
    CompletableFuture<Void> publishRegulatoryEvent(String positionKey, String regulatoryEvent);
}
